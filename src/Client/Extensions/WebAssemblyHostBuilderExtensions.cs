...
using dashboard.Client.Infrastructure.Authentication;
using dashboard.Client.Infrastructure.Managers;
using dashboard.Client.Infrastructure.Managers.Preferences;
...
using dashboard.Client.Infrastructure.Managers.ExtendedAttribute;
using dashboard.Domain.Entities.ExtendedAttributes;
using dashboard.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace dashboard.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        private const string ClientName = "flafarga.API";
