...
using dashboard.Client.Infrastructure.Routes;
using dashboard.Shared.Constants.Storage;
using Microsoft.Extensions.Localization;

namespace dashboard.Client.Infrastructure.Managers.Identity.Authentication
{
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((StateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Email);
