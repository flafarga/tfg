...
using dashboard.Application.Features.Products.Commands.Delete;
using dashboard.Application.Features.Products.Queries.Export;
using dashboard.Application.Features.Products.Queries.GetAllPaged;
using dashboard.Application.Features.Products.Queries.GetProductImage;
using dashboard.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace dashboard.Server.Controllers.v1.Catalog
{
