...
using dashboard.Application.Features.ExtendedAttributes.Commands.AddEdit;
using dashboard.Application.Features.ExtendedAttributes.Commands.Delete;
using dashboard.Application.Features.ExtendedAttributes.Queries.Export;
using dashboard.Application.Features.ExtendedAttributes.Queries.GetAll;
using dashboard.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using dashboard.Application.Features.ExtendedAttributes.Queries.GetById;
using dashboard.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace dashboard.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
